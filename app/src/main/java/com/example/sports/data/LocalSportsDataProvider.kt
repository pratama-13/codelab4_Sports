    ...
    fun getSportsData(): List<Sport> {
        return listOf(
            Sport(
                ...
                sportDetails = R.string.sport_detail_text1
            ),
            Sport(
                id = 2,
                ...
                sportDetails = R.string.sport_detail_text2
            ),
            Sport(
                id = 3,
                ...
                sportDetails = R.string.sport_detail_text3
            ),
            Sport(
                id = 4,
                ...
                sportDetails = R.string.sport_detail_text4
            ),
            Sport(
                id = 5,
                ...
                sportDetails = R.string.sport_detail_text5
            ),
            Sport(
                id = 6,
                ...
                sportDetails = R.string.sport_detail_text6
            ),
            Sport(
                id = 7,
                ...
                sportDetails = R.string.sport_detail_text7
            ),
            Sport(
                id = 8,
                ...
                sportDetails = R.string.sport_detail_text8
            ),
            Sport(
                id = 9,
